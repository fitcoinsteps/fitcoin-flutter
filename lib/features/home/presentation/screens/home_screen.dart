...
class _HomeScreenState extends ConsumerState<HomeScreen> {
                  ...
                  ...List.generate(3, (index) {
                    ...
                    return Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.white.withOpacity(isWatched ? 0.08 : 0.05),
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(
                            color: isWatched ? Colors.green.withOpacity(0.3) : Colors.white.withOpacity(0.1),
                          ),
                        ),
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                isWatched ? 'Ad ${index + 1} (Watched)' : 'Ad ${index + 1} (Pending)',
                                style: TextStyle(
                  ...
                  Opacity(
                    ...
                    child: GestureDetector(
                      onTap: hasAvailableAd
                          ? () {
                        final index = _watchedAds.indexWhere((watched) => !watched);
                        if (index != -1) {
                          setState(() {
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            hasAvailableAd ? 'Watch Next Ad' : 'All Ads Watched! 🎉',
            ...
            actions: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: _neonPink.withOpacity(0.2)),
                ),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(Icons.monetization_on, color: _neonPink, size: 18),
                  ...
                  GridView.count(
                    ...
                    children: [
                      _buildPremiumCard(
                        ...
                        onTap: () => _navigateTo(context, const EarningsScreen()),
                        label: 'View',
                      ),
                      _buildPremiumCard(
                      ...
                      _buildPremiumCard(
                        ...
                        onTap: () => _navigateTo(context, const ScratchCardScreen()),
                        label: 'Scratch',
                      ),
                      _buildPremiumCard(
  ...
  // دائرة + أيام
  // ==========================================================================
  Widget _buildStepsAndDays(StepLoaded state) {
    return Column(
      children: [
        Container(
          ...
          child: Stack(
            ...
            children: [
              ...
              StepProgressCard(stepData: state.stepData, isSyncing: state.isSyncing),
              Positioned(
                top: 0,
                right: 0,
                child: Container(
          ...
          child: Row(
            children: List.generate(_totalDays, (index) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  color: isActive ? _neonPurple.withOpacity(0.2) : Colors.white.withOpacity(0.04),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: isActive ? _neonPurple.withOpacity(0.6) : Colors.white.withOpacity(0.08),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.location_on, color: AppColors.primaryPurple, size: 28),
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 6),
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(colors: [Color(0xFFFFD93D), Color(0xFFFFA000)]),
                      borderRadius: BorderRadius.circular(20),
                      boxShadow: [
                        BoxShadow(
  ...
  // ==========================================================================
  // بطاقة المهام الفاخرة (تم إصلاح Overflow هنا)
  // ==========================================================================
      ...
      child: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [const Color(0xFF0A0A12).withOpacity(0.8), color.withOpacity(0.1)],
          ),
          borderRadius: BorderRadius.circular(20),
            ...
            if (badge != null)
              Positioned(
                ...
                child: Container(
                  padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(colors: [Color(0xFF00E676), Colors.green]),
                    borderRadius: BorderRadius.circular(12),
                  ),
                  child: Text(
                    badge,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // =========================================================
                  // ✅ تم إضافة FittedBox لمنع النص من الخروج عن الكارت
                  // =========================================================
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: glowColor.withOpacity(0.1), blurRadius: 20)],
        ),
        child: Row(
          children: [
            Container(
