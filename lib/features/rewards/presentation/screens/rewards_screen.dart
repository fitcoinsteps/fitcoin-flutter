...
class _RewardsScreenState extends ConsumerState<RewardsScreen> {
          ...
          GlobalAppBar(
            ...
            actions: [
              Row(
                ...
                children: [
                  Icon(Icons.monetization_on, color: AppColors.primaryPink, size: 20),
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  _buildPremiumWalletCard(fitcoinBalance, usdtValue),
  ...
  // القسم 1: المحفظة
  // ==========================================================================
  Widget _buildPremiumWalletCard(double fitcoinBalance, double usdtValue) {
    return Container(
  ...
  // ==========================================================================
  // القسم 3: بطاقات الهدايا (أيقونات معدلة)
  // ==========================================================================
  Widget _buildHorizontalGiftCardCarousel() {
    final List<Map<String, dynamic>> brands = [
      {
        'title': 'Amazon',
        'icon': Icons.shopping_bag_outlined, // تم استخدام حقيبة تسوق بدلاً من Icons.amazon
